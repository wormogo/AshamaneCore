...
-- Rokmora
DELETE FROM `creature` WHERE `id` = 91003 AND `map` = 1458;
INSERT INTO `creature` (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnDifficulties`, `phaseUseFlags`, `PhaseId`, `PhaseGroup`, `terrainSwapMap`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `unit_flags2`, `unit_flags3`, `dynamicflags`, `ScriptName`, `VerifiedBuild`) VALUES
(804943, 91003, 1458, 7546, 8338, '1', 0, 0, 0, -1, 0, 0, 2884.46, 1383.33, -2.40465, 0.559129, 300, 0, 0, 38927456, 1, 0, 0, 0, 0, 0, 0, '', 0);
...
-- Ularogg Cragshaper
DELETE FROM `creature` WHERE `id` = 91004 AND `map` = 1458;
INSERT INTO creature (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnDifficulties`, `phaseUseFlags`, `PhaseId`, `PhaseGroup`, `terrainSwapMap`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `unit_flags2`, `unit_flags3`, `dynamicflags`, `ScriptName`, `VerifiedBuild`) VALUES
(804944, 91004, 1458, 7546, 8340, '1', 0, 0, 0, -1, 0, 0, 2894.91, 1677.12, -35.2344, 3.358, 300, 0, 0, 38927456, 1, 0, 0, 0, 0, 0, 0, '', 0);
...
-- Naraxas
DELETE FROM `creature` WHERE `id` = 91005 AND `map` = 1458;
INSERT INTO creature (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnDifficulties`, `phaseUseFlags`, `PhaseId`, `PhaseGroup`, `terrainSwapMap`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `unit_flags2`, `unit_flags3`, `dynamicflags`, `ScriptName`, `VerifiedBuild`) VALUES
(804945, 91005, 1458, 7546, 8340, '1', 0, 0, 0, -1, 0, 0, 2989.42, 1828.94, -59.5405, 5.341, 300, 0, 0, 38927456, 1, 0, 0, 0, 0, 0, 0, '', 0);
...
-- Dargrul
DELETE FROM `creature` WHERE `id` = 91007 AND `map` = 1458;
INSERT INTO creature (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnDifficulties`, `phaseUseFlags`, `PhaseId`, `PhaseGroup`, `terrainSwapMap`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `unit_flags2`, `unit_flags3`, `dynamicflags`, `ScriptName`, `VerifiedBuild`) VALUES
(804946, 91007, 1458, 7546, 8340, '1', 0, 0, 0, -1, 0, 0, 2716.96, 2044.85, -201.9335, 6.249, 300, 0, 0, 38927456, 1, 0, 0, 0, 0, 0, 0, '', 0);
