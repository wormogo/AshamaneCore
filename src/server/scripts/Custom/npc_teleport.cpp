...
namespace 
{
    ...
    void GetMenuStr() {
                next_page = string_To_UTF8("-> [Next]");
                previous_page = string_To_UTF8("<- [previous page]");
                main_menu = string_To_UTF8("<= [Main Menu]");
                no_required_level = string_To_UTF8("You have not met the grade requirements.");
                no_enough_money = string_To_UTF8("You don't have enough gold coins. The transfer fee is");
                in_combat = string_To_UTF8("You are still in the battle. Please come back later.");
